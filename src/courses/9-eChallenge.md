...
CLOs:
  - >-
    Identify and evaluated a potential entrepreneurial or change management
    opportunity using a systematic process.
  - >-
    Determine a practical resourcing strategy to exploit the opportunity in an
    innovative manner.
  - >-
    Build an effective entrepreneurial team to develop strategies to exploit the
    opportunity.
  - >-
    Communicate and present the new entrepreneurial venture to relevant
    stakeholders, including investors."
  - >-
    Replicate the process of assessing the viability of entrepreneurial
    opportunities for future endeavours.
Topics:
  - 'Ideas, Opportunities and Team Formation'
  - Team Strengths and Customer Identification
  - Needs Assessment and Communication Skills
  - Creating Value and Business Modelling
  - Speed Dating with Mentors
  - Prototyping
  - Marketing
  - Venture Showcase
  - Market Evaluation & Financing Your Venture
  - Value Re-positioning
  - Pitch Coaching for Semi-Finals
  - Semi-Finals
Assessments:
