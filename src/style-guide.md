...
>1. Topic
>2. The set challenge or question
>3. Scope and scale
>4. What kinds of analysis or other tasks are suggested
>5. What datasets are provided (under 'Dataset Highlight")
>6. What previous work has been done by teams in the competition (under 'Challenge Entries')
...
>1. the topic  
>1. the set challenge or question  
>1. the scope and scale 
>1. what kinds of analysis or other tasks are suggested 
>1. what datasets are provided (under 'Dataset Highlights') 
>1. what previous work has been done by teams in the competition (under 'Challenge Entries'). 
...
![Figcaption example]({{'../images/pages/figcaption.png' | url }})
...
![Figcaption example]({{'../images/pages/figcaption-ssb.png' | url }})
...
![Alt text in Smart Storyboard example]({{'../images/pages/alt-text-ssb.png' | url }})
...
The Web Accessibility Initiative website has [a useful decision tree to help you decide](https://www.w3.org/WAI/tutorials/images/decision-tree/) whether your image requires an alt tag, and if so, what should be included.
...
![Long description example]({{'../images/pages/long-example.png' | url }})

Within Smart Storyboard, this would be the content present inside the block in a Lesson view.

![Long description in Smart Storyboard example]({{'../images/pages/long-ssb.png' | url }})
